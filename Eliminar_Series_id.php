...
<body>
	<form action="Eliminar_Series_id2.php" method="post">
<?php
	$ip = "localhost";
	$usr = "root";
	$pass = "459255";
	...
	if ($result->num_rows > 0){
		$row = $result->fetch_assoc();
            ...
            echo('TEMPORADAS <br><input class="Entrada" type="text" name="Duracion" value="'.$row["Temporadas"].'"readonly><br>');
            echo('RATING <br><input class="Entrada" type="text" name="Rating" value="'.$row["Rating"].'" readonly><br>');
			echo('CAPITULOS <br><input class="Entrada" type="text" name="Productora" value="'.$row["Capitulos"].'"readonly><br>');
